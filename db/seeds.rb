...
parent = Category.create(name: 'おもちゃ')
...
#⑧家電・スマホ・カメラ
home_appliances_child_array = ['スマートフォン/携帯電話','スマホアクセサリー','PC/タブレット','テレビ/映像機器','オーディオ機器','美容/健康','冷暖房/空調','生活家電','その他',]
...
parent = Category.create(name: '家電')
home_appliances_child_array.each_with_index do |child, i|
 child = parent.children.create(name: child)
 home_appliances_grandchild_array[i].each do |grandchild|
   child.children.create(name: grandchild)
 end
end
...
parent = Category.create(name: 'スポーツ')
...
#⑩ハンドメイド
hand_made_child_array = ['アクセサリー(女性用)','ファッション/小物','アクセサリー/時計','日用品/インテリア','趣味/おもちゃ','キッズ/ベビー','二次創作物','その他']

hand_made_grandchild_array = [['すべて','ピアス','イヤリング','ネックレス','ブレスレット','リング','チャーム','ヘアゴム','アンクレット','その他'], ['すべて','バッグ(女性用)','バッグ(男性用)','財布(女性用)','財布(男性用)','ファッション雑貨','その他'], ['すべて','アクセサリー(男性用)','時計(女性用)','時計(男性用)','その他'], ['すべて','キッチン用品','家具','文房具','アート/写真','アロマ/キャンドル','フラワー/ガーデン','その他'], ['すべて','クラフト/布製品','おもちゃ/人形','その他'], ['すべて','ファッション雑貨','スタイ/よだれかけ','外出用品','ネームタグ','その他'], ['すべて','各種パーツ','生地/糸','型紙/パターン','その他'], ['すべて','Ingress','クリエイターズ宇宙兄弟','その他'], ['すべて']]

parent = Category.create(name: 'ハンドメイド')
hand_made_child_array.each_with_index do |child, i|
 child = parent.children.create(name: child)
 hand_made_grandchild_array[i].each do |grandchild|
   child.children.create(name: grandchild)
 end
end
...
car_grandchild_array = [['すべて','国内自動車本体','外国自動車本体','その他'], ['すべて','タイヤ/ホイールセット','タイヤ','ホイール','その他'], ['すべて','サスペンション','ブレーキ','外装、エアロパーツ','ライト','内装品、シート','ステアリング','マフラー・排気系','エンジン、過給器、冷却装置','クラッチ、ミッション、駆動系','電装品','補強パーツ','汎用パーツ','外国自動車用パーツ','その他'], ['すべて','車内アクセサリー','カーナビ','カーオーディオ','車外アクセサリー','メンテナンス用品','チャイルドシート','ドライブレコーダー','レーダー探知機','カタログ/マニュアル','セキュリティ','ETC','その他'], ['すべて'], ['すべて','タイヤ','マフラー','エンジン、冷却装置','カウル、フェンダー、外装','サスペンション','ホイール','シート','ブレーキ','タンク','ライト、ウィンカー','チェーン、スプロケット、駆動系','メーター','電装系','ミラー','外国オートバイ用パーツ','その他'], ['すべて','ヘルメット/シールド','バイクウエア/装備','アクセサリー','メンテナンス','カタログ/マニュアル','その他']]

parent = Category.create(name: '自動車')
